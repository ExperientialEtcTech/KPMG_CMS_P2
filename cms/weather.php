...
<body>
    ...
    <div class="row-data">
        ...
        <div style="height:50px;width:1000px;text-align: center;color: #00338D;text-align: center;font-size: 45px;margin:0px;cursor: context-menu;">
            ...
            <div style="height:50px;float: right;background-image:url('assets/Logout button.png');background-repeat:no-repeat;padding-left:130px; background-size: contain;cursor:pointer;"onclick="location.href='login.php';">
	
        </div>
		
    </div>
	<p style="margin: 0 auto;color:red;font-size:40%;padding-top:3%">
								*Primary city cannot be deleted, it can be only changed. 
								</p><br>
    ...
    <div class="row-data">
        <div class="row-data-left">
            ...
            <div class="row-data-left">
                ...
                echo '
				<img src="assets/Group258-01.png" class="map-red"/>
