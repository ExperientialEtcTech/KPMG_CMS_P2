...
<body class="body-bg">
                ...
                <div class="row justify-content-md-center">
                    <div class=" col-xs-12 col-sm-12 col-md-10 col-lg-10">
                        <div class=" table-responsive">
							<div style="align:center; margin-top:4%;margin-bottom:3%">
								<p style="margin: 0 auto;color:red;font-size:120%">
								*Any changes done in this cms welcome screen, will be reflected on welcome screen (entrance screen) on the next day after 9am
								</p>
							</div>
                            <!-- table -->
                            <table class="table">
 ...
 KPMG Assurance and Consulting Services LLP has entered into sub-license arrangements with certain entities in India. These application(s) are also for the use of such sub-licensees in India.</span>
    ...
    document.getElementById("loop_vid").value = sessionStorage.getItem('loop_vid');
    document.getElementById("KPMG_logo").value = sessionStorage.getItem('KPMG_logo');
    document.getElementById("bg_vid").value = sessionStorage.getItem('bg_vid');
    document
