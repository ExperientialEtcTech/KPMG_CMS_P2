...
<div style="width: 800px;height:px;margin:auto;">
...
<div style="width: 1200px;height:100px;margin:auto;">
    <label class="lbl">Item 01</label>
     ...
     View <br> Sub Service
      ...
      <button class="btn1" style="background-color: darkblue;color:white;font-size: 20px;" onclick="location.href='FirstLevelServices_2.php';cursor: pointer;">View Content</button>
