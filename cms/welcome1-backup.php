...
<body class="body-bg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body changePopup">
                    <div class="example" style="margin:auto;">
                        ...
                        <button type="submit" name="textbtn" id="textbtn"><img src="assets/search.png" width="20px"/></button>
                    </div>
    ...
    bg_vid === " <?php echo $response['bg_vid']; ?>" ? sessionStorage.setItem('bg_vid',
        '<?php echo $response['bg_vid']; ?>') : document.getElementById("bg_vid").value = bg_vid.substring(bg_vid
        .lastIndexOf('/') + 1);
